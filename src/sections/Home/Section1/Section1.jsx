    ...
    <div class="container mx-auto h-screen">
        <div class="md:flex hero-wrap">
            <div class="hero-text-wrap ">
               ...
               <a href="#_" class="rounded relative d-inline-flex group items-center justify-center px-3.5 py-2 mt-3
                    ...
                    <div class="circle-big p-9 motion-safe:animate-pulse ">
                        ...
                        <div className="flex align-items-center">
                          <div className="bg-[rgba(255,255,255,0.6)] backdrop-blur-sm w-12 h-12 rounded flex align-items-center justify-center">
                             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#dba627" className=" h-6">
                       ...
                       <div className="flex align-items-center">
                        <div className="bg-[rgba(255,255,255,0.6)] backdrop-blur-sm w-12 h-12 rounded flex align-items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#dba627" className="w-6 h-6">
